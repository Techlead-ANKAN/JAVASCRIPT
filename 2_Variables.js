...
// 3."const"
//        a) Once declared cannot change the value afterward (immutable)
...
//        f) Declaring a "const" variable without an initial value will result in a Syntax Error.
//        g) usually "const" variables are uppercased to distinguished from others.
...
function sample_func() {
  var name = "Ankan";
  console.log("Inside Block: " + name); // this will show Ankan
}
sample_func();

console.log("Outside Block: " + name); // this will show Piu
...
// 2.
//console.log(gender); //  ReferenceError: "gender" is not defined (undeclared)
...
// 4.
//console.log(newvar); // newvar is not defined. Cannot access the variable before using it.
...
// 3.
const STUDENTS = ["Ankan", "Piu"];
// STUDENTS = ["abc", "def"];  // not mutable
